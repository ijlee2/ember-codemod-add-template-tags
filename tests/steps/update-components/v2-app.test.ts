...
test('steps | update-components > v2-app', async function () {
  const outputProject = {
    app: {
      components: {
        ui: {
          form: {
            'checkbox.gts': normalizeFile([
        ...
        'navigation-menu.gjs': normalizeFile([`<template></template>`, ``]),
        'select-locale.gjs': normalizeFile([
          `import Component from '@glimmer/component';`,
          ``,
