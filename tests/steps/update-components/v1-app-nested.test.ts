...
test('steps | update-components > v1-app (nested)', async function () {
  const outputProject = {
    app: {
      components: {
        ui: {
          form: {
            ...
            information: {
              'index.gts': normalizeFile([
                ...
                ``,
                `const UiFormInformation = <template></template> satisfies TOC<UiFormInformationSignature>;`,
                ``,
          ...
          page: {
            'index.gjs': normalizeFile([
              `const UiPage = <template></template>;`,
              ``,
